  ...
  return (
    <>
      <div className={`${welcomeClass} absolute inset-0`} style={{ transformOrigin: "50% 50%" }}>
        ...
        <div className="absolute inset-0 flex flex-col md:flex-row items-center justify-start md:justify-center text-center md:text-left px-6 pt-16 md:pt-0 gap-2 md:gap-32 overflow-y-auto">
          <div className="space-y-6 max-w-3xl">
            ...
            <div className={`flex justify-center md:justify-start flex-wrap gap-4 pt-4 ${styles.mobileClearMoon}`}>
              <button
            ...
            <div className="flex justify-center md:justify-start mt-2 md:mt-6 pt-0 md:pt-2">
              <button
                onClick={onDive}
                className="px-6 py-2 md:py-3 border border-cyan-400 rounded-full bg-cyan-500/10 text-cyan-300 hover:bg-cyan-500/20 transition shadow-[0_0_28px_rgba(56,189,248,0.35)]"
              >
